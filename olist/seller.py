...
class Seller:
    ...
    def get_active_dates(self):
        ...
        return orders.merge(self.matching_table[['seller_id', 'order_id']], on = 'order_id').groupby('seller_id')\
            .agg({
                "date_first_sale": min,
                "date_last_sale": max
            })
    ...
    def get_review_score(self):
        ...
        df = df.groupby('seller_id', as_index = False)\
            .agg({
        ...
        df.columns = ['seller_id', 'share_one_stars', 'share_of_five_stars', 'review_score']
